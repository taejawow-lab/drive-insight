...
1. Clean glass, mirrors, lights, and wipers before sunset.
2. Plan rest stops, driver swaps, navigation, and a turn-back point before fatigue builds.
3. Increase following distance and slow down when glare, rain, insects, or low contrast reduce visibility.
4. Keep route changes, phone use, and passenger tasks out of the driver’s hands while moving.
5. Record what caused glare or fatigue so the next night trip is scheduled more safely.
