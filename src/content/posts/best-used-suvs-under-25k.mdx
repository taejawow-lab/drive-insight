...
For sedan equivalents at lower price points, see the Camry and [Civic](/posts/used-honda-civic-2018-2022) analyses — same data sources, same methodology, smaller vehicles for those who don't need the SUV size or AWD.
